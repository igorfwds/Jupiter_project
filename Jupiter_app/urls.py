...
urlpatterns = [
    ...
    path('homePaciente/exames/examehemograma/', views.examehemograma, name='examehemograma'),
    path('homePaciente/exames/exameurina/', views.exameurina, name='exameurina'),
    path('homePaciente/receituarios/receita', views.receita, name='receita'),
    path('homePaciente/booking/', views.booking, name='booking'),
    path('homePaciente/booking/booking-submit', views.bookingSubmit, name='bookingSubmit'),
