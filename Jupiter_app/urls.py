...
urlpatterns = [
    ...
    path('user-update/<int:appointment_id>', views.userUpdate, name='userUpdate'),
    path('user-update-submit/<int:appointment_id>/', views.userUpdateSubmit, name='userUpdateSubmit'),
